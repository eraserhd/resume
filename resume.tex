...
\achievement{nexus}{Modernized $\sim$60 services from an acquisistion, introducing CI/CD and kubernetes,
enabling independent team deploys,
analyzing code and incrementally rearchitecting for horizontal scaling and blue/green deploys
}\\
\achievement{centralpark}{Built and maintained a system orchestrating multiple cross-team systems}\\
\achievement{coresystems}{Built and maintained serverless integrations synchronizing systems}\\
\achievement{passport}{MySQL schema analysis, modifications, and code changes revamping a critical, aging data cache}\\
\achievement{guided}{Guided the organization's technical direction}

\experienceitem{Software Engineer IV}{Groupon}{2013--2016}
\achievement{whitepaper}{Provided clear analysis which broke a delivery-limiting stalemate between tech and purchasing}\\
\achievement{points}{Designed and wrote Points, a new customer retention program} \\
\achievement{homepage}{Delivered a new homepage, enabling better user targeting} \\
...
\achievement{hearts}{Maintained Hearts and Spades iPad games}\\
\achievement{heartsnet}{Designed and wrote Hearts and Spades online mode and servers}
