...
\null\hfill
\wordcloud[rotate=45,margin=1pt,usecolor]{
  (Clojure,10);
  (PostgreSQL,9);
  (Linux,9);
  (OpenSCAD,9);
...
\begin{tikzpicture}[remember picture, overlay,
                    ...
                    white!60!black,
                    rounded corners]
    \draw (broadbrief) -- ++(0.3,0) |- (centralpark);
    \draw (broadbrief) -- ++(0.3,0) |- (points);
    \draw (writing) -- ++(0.8,0) |- (whitepaper);
\end{tikzpicture}%
\end{document}
